...
;
;
function CopyButton({ text, label = "Copy", className, variant = "outline", size = "sm" }) {
    _s();
...
"[project]/lib/saved.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SAVED_EVENT = "tooldrop:saved-changed";
;
function readRaw() {
    ...
    try {
        ...
        return parsed.filter((x)=>x?.kind && x?.id).map((x)=>({
                kind: x.kind,
                id: String(x.id)
            }));
    } catch  {
...
function readSaved() {
    const keys = readRaw();
    const all = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUnifiedIndex"])();
    const map = new Map(all.map((it)=>[
            `${it.kind}:${it.id}`,
            it
        ]));
    return keys.map((k)=>map.get(`${k.kind}:${k.id}`)).filter(Boolean).map((it)=>{
        const x = it;
        return {
            kind: x.kind,
            id: x.id,
...
function toggleSaved(key, limit = 200) {
    const keys = readRaw();
    const exists = keys.some((x)=>x.kind === key.kind && x.id === key.id);
    const next = exists ? keys.filter((x)=>!(x.kind === key.kind && x.id === key.id)) : [
        {
            kind: key.kind,
            id: key.id
        },
...
"[project]/components/save-button.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$saved$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/saved.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
;
;
function SaveButton({ kind, id, className, labelSaved = "Saved", labelUnsaved = "Save" }) {
    _s();
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "SaveButton.useEffect": ()=>{
            setSaved((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$saved$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSaved"])(kind, id));
        }
    }["SaveButton.useEffect"], [
        kind,
        id
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "SaveButton.useEffect": ()=>{
            const sync = {
                "SaveButton.useEffect.sync": ()=>setSaved((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$saved$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSaved"])(kind, id))
            }["SaveButton.useEffect.sync"];
            // same-tab updates (our custom event)
            window.addEventListener(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$saved$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SAVED_EVENT"], sync);
            ...
            return ({
                "SaveButton.useEffect": ()=>{
                    window.removeEventListener(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$saved$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SAVED_EVENT"], sync);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
        ...
        className: className,
        onClick: ()=>{
            const next = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$saved$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toggleSaved"])({
                kind,
                id
            });
            setSaved(next);
        ...
        children: [
            saved ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$bookmark$2d$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BookmarkCheck$3e$__["BookmarkCheck"], {
                ...
                fileName: "[project]/components/save-button.tsx",
                lineNumber: 58,
                columnNumber: 16
...
_s(SaveButton, "90f/67fVv3Gb+X0kjpTCvIsNupM=");
_c = SaveButton;
var _c;
...
"[project]/components/track-recent.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function TrackRecent({ kind, id, slug, title, subtitle }) {
    _s();
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "TrackRecent.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$recent$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addRecent"])({
                kind,
                id,
                slug,
                title,
...
_s(TrackRecent, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = TrackRecent;
var _c;
__turbopack_context__.k.register(_c, "TrackRecent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_1b338210._.js.map