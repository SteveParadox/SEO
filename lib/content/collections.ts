...
export const collections: Collection[] = [
  ...
  {
    id: "c36",
    slug: "relationship-texting-starter-pack",
    title: "Relationship Texting Starter Pack (Sweet, Calm, Not Cringe)",
    description:
      "Text better in relationships without sounding awkward, dramatic, or weirdly formal.",
    longDescription: "Relationship texting gets hard when the feeling is real but the wording feels slippery. This collection groups prompts for affectionate daily texts, milestone notes, apologies, and boundary-setting so people can move from blank-screen stress to messages that actually sound like them.",
    whoItsFor: "People dating, in relationships, long-distance couples, or anyone who wants help with tone-sensitive relationship messages.",
    howToUse: "Start with the prompt closest to the moment you are in: daily warmth, apology, milestone, or boundary. Use the output as a draft, then add one real detail so the message feels yours.",
    commonMistakes: "Using overly generic romantic language. Choosing the wrong prompt for the emotional situation. Copying the output without adjusting it to the relationship stage.",
    successMetrics: "The messages feel sendable, specific, and emotionally appropriate. You spend less time overthinking wording and more time communicating well.",
    items: [
      { kind: "prompt", id: "p75" },
      { kind: "prompt", id: "p77" },
      { kind: "prompt", id: "p57" },
  ...
  {
    id: "c37",
    slug: "low-energy-student-survival-kit",
    title: "Low-Energy Student Survival Kit",
    description:
      "Get through school work when motivation is low and the deadline does not care.",
    longDescription: "Students often do not need another perfect study plan. They need something that works when they are tired, behind, overwhelmed, or avoiding the task completely. This collection groups the prompts that help turn stress into one doable next step.",
    whoItsFor: "Students who procrastinate, cram, feel overwhelmed, or struggle to get started on school work even when they know what matters.",
    howToUse: "Use the no-motivation prompt first if you are frozen. Move to the assignment or cram prompts once you can see the task more clearly. Use the professor email prompt when the problem requires communication, not just effort.",
    commonMistakes: "Jumping to a huge study plan too early. Ignoring deadlines while only trying to feel more motivated. Leaving communication too late when an instructor should be informed.",
    successMetrics: "You start earlier, break work down faster, and stop losing hours to the blank-screen phase of studying.",
    items: [
      { kind: "prompt", id: "p79" },
      { kind: "prompt", id: "p80" },
      { kind: "prompt", id: "p81" },
    ...
    tags: ["students", "study", "school", "productivity"],
    updatedAtISO: "2026-04-20",
  },
  {
    id: "c38",
    slug: "women-week-reset-kit",
    title: "Women's Week Reset Kit",
    description:
      "Plan a lower-friction week around energy, home load, boundaries, and realistic priorities.",
    longDescription: "A lot of weekly stress is invisible planning work: what to move, what to keep, what to drop, and how to protect energy without everything falling apart. This collection focuses on practical weekly support rather than vague lifestyle advice.",
    whoItsFor: "Busy women balancing work, study, home, relationships, and low-energy weeks where reality needs a gentler plan.",
    howToUse: "Use the period-week planner or daily fixer first depending on what feels most urgent. Pull in the household reset or polite-decline prompts if the pressure is coming from home chaos or too many asks.",
    commonMistakes: "Planning the week as if your capacity never changes. Using guilt as a planning strategy. Trying to solve everything in one reset session.",
    successMetrics: "The week feels calmer, the most important things still get protected, and the plan respects actual capacity instead of fantasy capacity.",
    items: [
      { kind: "prompt", id: "p83" },
      { kind: "prompt", id: "p84" },
      { kind: "prompt", id: "p85" },
    ...
    tags: ["women", "planning", "reset", "lifestyle"],
    updatedAtISO: "2026-04-20",
  },
  {
    id: "c39",
    slug: "social-posting-starter-pack",
    title: "Social Posting Starter Pack",
    description:
      "Move faster on captions, hooks, bios, replies, and launch posts without posting generic filler.",
    longDescription: "Most social posting friction comes from knowing roughly what to say but not having a clean format or tone. This collection groups the strongest starter prompts for posting, rewriting, repurposing, and staying active across multiple platforms.",
    whoItsFor: "Creators, freelancers, small businesses, founders, and anyone trying to post more consistently without sounding repetitive.",
    howToUse: "Pick the prompt that matches the format you are shipping today: caption, hook, carousel, bio, launch post, or comment reply. Use the repurposer when you already have a source asset to work from.",
    commonMistakes: "Using the same tone everywhere. Posting platform-generic copy. Starting with hashtags before the post idea itself is clear.",
    successMetrics: "Posting gets faster, the outputs fit the platform better, and fewer drafts die in the notes app.",
    items: [
      { kind: "prompt", id: "p65" },
      { kind: "prompt", id: "p66" },
      { kind: "prompt", id: "p68" },
    ...
    tags: ["social-media", "creator", "content", "marketing"],
    updatedAtISO: "2026-04-20",
  },
  {
    id: "c40",
    slug: "school-admin-and-recovery-kit",
    title: "School Admin and Recovery Kit",
    description:
      "Handle the communication and catch-up side of school without spiraling.",
    longDescription: "A lot of academic stress comes from the admin layer around the work: emailing professors, asking for clarity, deciding what to tackle first, and recovering when you are already behind. This collection supports that messy middle.",
    whoItsFor: "Students who are behind, confused, juggling multiple classes, or trying to clean up school stress without pretending everything is under control.",
    howToUse: "Use the assignment planner or cram prompt to figure out the task, then use the professor email prompt when communication is the next blocker. If the bigger problem is a broken day, use the schedule fixer first.",
    commonMistakes: "Waiting until panic is extreme before reaching out. Making a school plan that ignores the non-school stress causing the delay. Overthinking the perfect wording when a clear email would help immediately.",
    successMetrics: "You make contact earlier, catch up faster, and spend less time in the loop between stress and avoidance.",
    items: [
      { kind: "prompt", id: "p80" },
      { kind: "prompt", id: "p81" },
      { kind: "prompt", id: "p82" },
    ...
    tags: ["students", "school", "communication", "recovery"],
    updatedAtISO: "2026-04-20",
  },
  {
    id: "c41",
    slug: "soft-boundaries-and-polite-no-pack",
    title: "Soft Boundaries and Polite No Pack",
    description:
      "Say no, step back, or protect your time without starting a whole emotional fire.",
    longDescription: "Many everyday communication problems sit in the space between warmth and firmness. This collection brings together prompts that help people decline, set limits, follow up calmly, and communicate with less guilt and less confusion.",
    whoItsFor: "Anyone who struggles to say no clearly, people-pleases by default, or wants more emotionally steady communication with friends, family, coworkers, and dating situations.",
    howToUse: "Choose the polite decline prompt when the situation is social or lightly formal. Use the soft-boundary or difficult-text prompts when the message needs clearer emotional framing or more firmness.",
    commonMistakes: "Being too vague. Over-apologizing. Choosing a gentle prompt when the real need is a firmer boundary. Writing a message that sounds polite but still invites endless negotiation.",
    successMetrics: "The messages get clearer, you explain less, and the other person understands the limit sooner.",
    items: [
      { kind: "prompt", id: "p78" },
      { kind: "prompt", id: "p85" },
      { kind: "prompt", id: "p56" },
    ...
    tags: ["boundaries", "communication", "texting", "lifestyle"],
    updatedAtISO: "2026-04-20",
  },
];
