...
export const comparisons: Comparison[] = [
...

  {
    ...
    whenToUse: "Reference this when selecting text-to-speech for content production, building voice interfaces, creating audiobook narration, adding voice to products, scaling from prototype to production, or when voice quality directly impacts customer experience and retention. Critical decision point when users will listen to synthetic voices regularly, where poor quality creates negative impressions, or when voice consistency across content matters.",
    ...
    keyTradeoffs: "ElevenLabs delivers noticeably superior voice quality with strong aesthetic results but costs more per character, imposes stricter commercial licensing terms, and creates vendor lock-in if quality becomes mission-critical. PlayHT balances decent voice quality against moderate costs and good voice variety, but sometimes voices feel inconsistent across updates. Azure TTS deliberately trades some aesthetic quality for enterprise reliability, predictable transparent pricing, reliable integration with existing Microsoft infrastructure, and reduced vendor risk.",
  ...
  {
    id: "cmp21",
    slug: "whatsapp-reply-helper-vs-difficult-text-reply-vs-soft-boundary-text-writer",
    title: "WhatsApp Reply Helper vs Difficult Text Reply vs Soft Boundary Text Writer",
    description: "Three texting prompts for very different social moments: everyday replies, tense messages, and kinder boundary-setting.",
    whenToUse: "Use this comparison when you know the message matters but you are not sure which prompt fits the situation. It is especially useful when the emotional tone of the conversation could shift badly if you choose the wrong kind of draft.",
    decisionContext: "These prompts solve adjacent but different problems. One is built for normal reply flow, one is built for emotionally loaded texts, and one is built for saying less while still protecting your space. Choosing the right one depends more on the emotional job of the message than on the platform.",
    keyTradeoffs: "WhatsApp Reply Helper is best for everyday tone and flow but can be too light for conflict. Difficult Text Reply handles tension and emotional weight better but can feel too serious for simple messages. Soft Boundary Text Writer is strongest when the main goal is a kind limit, but it is not meant for deep repair or relationship warmth.",
    realWorldScenarios: "Use WhatsApp Reply Helper for normal conversations and slightly awkward day-to-day replies. Use Difficult Text Reply when the message carries tension, blame, or pressure. Use Soft Boundary Text Writer when you need to slow something down, say no, or protect your time without escalating.",
    successMetrics: "The best prompt should reduce overthinking, match the emotional temperature, and help you send something clear without rewriting it ten times.",
    contenders: [
      { kind: "prompt", id: "p55" },
      { kind: "prompt", id: "p56" },
      { kind: "prompt", id: "p78" },
    ...
    criteria: [
      { name: "Tone fit", notes: "How well it matches casual, tense, or boundary-heavy situations." },
      { name: "Emotional clarity", notes: "Whether the prompt helps you say what you mean without muddling it." },
      { name: "Relationship sensitivity", notes: "How well it respects the closeness and stakes of the relationship." },
      { name: "Reusability", notes: "How often the prompt feels useful across repeated everyday scenarios." },
    ],
    verdict:
      "Use WhatsApp Reply Helper for normal social flow, Difficult Text Reply for emotional tension, and Soft Boundary Text Writer when the core job is a polite but real limit.",
    tags: ["texting", "relationships", "comparison", "prompts"],
    updatedAtISO: "2026-04-20",
  },
  {
    id: "cmp22",
    slug: "good-morning-text-writer-vs-anniversary-message-writer-vs-apology-message-writer",
    title: "Good Morning Text Writer vs Anniversary Message Writer vs Apology Message Writer",
    description: "Three relationship-writing prompts with very different emotional jobs: everyday affection, milestone warmth, and repair.",
    whenToUse: "Use this when you want to write to a partner but are choosing between daily warmth, a meaningful milestone, or repairing a mistake. The right prompt depends on the emotional goal of the message, not just the relationship itself.",
    decisionContext: "A good relationship message is not only about sounding sweet. Sometimes the goal is light connection, sometimes depth and gratitude, and sometimes accountability. These prompts work best when they are not used interchangeably.",
    keyTradeoffs: "Good Morning Text Writer is light, affectionate, and repeatable, but not enough for bigger emotional moments. Anniversary Message Writer handles milestones well but is too heavy for normal daily texting. Apology Message Writer is strongest when repair matters, but it is the wrong fit if the situation calls for warmth rather than accountability.",
    realWorldScenarios: "Use Good Morning Text Writer for daily affection or long-distance rhythm. Use Anniversary Message Writer for milestone notes, captions, or cards. Use Apology Message Writer after a misstep, misunderstanding, or missed expectation that needs real ownership.",
    successMetrics: "The best prompt should match the emotional purpose of the message and help you avoid being either too light or too dramatic for the moment.",
    contenders: [
      { kind: "prompt", id: "p75" },
      { kind: "prompt", id: "p77" },
      { kind: "prompt", id: "p57" },
    ...
    criteria: [
      { name: "Moment fit", notes: "How well the prompt matches daily, milestone, or repair situations." },
      { name: "Emotional depth", notes: "Whether it provides the right amount of feeling without overshooting." },
      { name: "Specificity", notes: "How well the prompt encourages personal details instead of generic lines." },
      { name: "Sendability", notes: "How easy the output feels to actually send without heavy rewriting." },
    ],
    verdict:
    ...
    tags: ["relationships", "romance", "comparison", "prompts"],
    updatedAtISO: "2026-04-20",
  },
  {
    id: "cmp23",
    slug: "no-motivation-study-starter-vs-assignment-breakdown-planner-vs-exam-cram-rescue-plan",
    title: "No-Motivation Study Starter vs Assignment Breakdown Planner vs Exam Cram Rescue Plan",
    description: "Three student prompts for three different failure points: getting started, structuring the task, and surviving the last-minute rush.",
    whenToUse: "Use this when you are behind or blocked on school work and need to choose the right kind of help. These prompts solve different stages of academic stress, so choosing well matters.",
    decisionContext: "Students often reach for the wrong prompt because everything feels like one giant problem. In practice, the issue is usually one of three things: you cannot start, you cannot structure the task, or the deadline is close enough that you need triage instead of a full plan.",
    keyTradeoffs: "No-Motivation Study Starter is best for activation and friction reduction but not for mapping a big assignment. Assignment Breakdown Planner is best when the task is too big or unclear but not yet in crisis mode. Exam Cram Rescue Plan is strongest under real time pressure, but it is not a substitute for normal planning if the deadline is still manageable.",
    realWorldScenarios: "Use No-Motivation Study Starter when you are frozen and avoiding the work. Use Assignment Breakdown Planner when the task is large and confusing. Use Exam Cram Rescue Plan when the exam is very close and prioritization matters more than perfect coverage.",
    successMetrics: "The best prompt should help you do the next right thing faster instead of making the whole academic problem feel even larger.",
    contenders: [
      { kind: "prompt", id: "p79" },
      { kind: "prompt", id: "p80" },
      { kind: "prompt", id: "p82" },
    ...
    criteria: [
      { name: "Best use case", notes: "Whether the prompt is strongest for starting, structuring, or rescue-mode studying." },
      { name: "Stress suitability", notes: "How well it fits low motivation versus real deadline panic." },
      { name: "Actionability", notes: "How fast the prompt turns panic into concrete next steps." },
      { name: "Academic realism", notes: "Whether the plan matches actual student time and energy." },
    ],
    verdict:
    ...
    tags: ["students", "study", "comparison", "prompts"],
    updatedAtISO: "2026-04-20",
  },
  {
    id: "cmp24",
    slug: "professor-email-writer-vs-follow-up-message-writer-vs-rewrite-for-clarity",
    title: "Professor Email Writer vs Follow-Up Message Writer vs Rewrite for Clarity",
    description: "Three writing prompts that all improve communication, but for very different types of messages.",
    whenToUse: "Use this when you know your draft needs help but you are not sure whether the real problem is academic email etiquette, follow-up timing, or just unclear wording.",
    decisionContext: "A rough message can fail for different reasons. Sometimes you need a more respectful academic email structure, sometimes you need a cleaner follow-up strategy, and sometimes you already have the right message but it is just wordy or unclear.",
    keyTradeoffs: "Professor Email Writer is best for school-specific tone and structure but too narrow for general follow-up. Follow-Up Message Writer is strongest when timing and gentle nudging matter, but less suited to formal academic asks. Rewrite for Clarity works well on existing drafts but assumes you already know what you want to say.",
    realWorldScenarios: "Use Professor Email Writer for course-related communication. Use Follow-Up Message Writer for delayed replies, reminders, and next-step nudges. Use Rewrite for Clarity when the message exists but feels messy, vague, or hard to scan.",
    successMetrics: "The right prompt should make the communication cleaner for the exact reason it was weak, not just make it sound more polished.",
    contenders: [
      { kind: "prompt", id: "p81" },
      { kind: "prompt", id: "p63" },
      { kind: "prompt", id: "p3" },
    ...
    criteria: [
      { name: "Context fit", notes: "How well the prompt matches academic, professional, or general communication." },
      { name: "Clarity gain", notes: "How much it improves readability and directness." },
      { name: "Tone control", notes: "Whether the prompt helps you sound respectful without sounding stiff." },
      { name: "Best starting point", notes: "Whether it is strongest from scratch or as a draft-improvement tool." },
    ],
    verdict:
    ...
    tags: ["email", "students", "writing", "comparison"],
    updatedAtISO: "2026-04-20",
  },
  {
    id: "cmp25",
    slug: "instagram-caption-writer-vs-linkedin-post-writer-vs-x-thread-writer",
    title: "Instagram Caption Writer vs LinkedIn Post Writer vs X Thread Writer",
    description: "Three social-writing prompts for three very different posting styles and audience expectations.",
    whenToUse: "Use this comparison when you have an idea to post but are not sure which social format or prompt structure will carry it best. It is especially useful when the same idea could become a caption, a single-post take, or a thread.",
    decisionContext: "Platform fit matters more than people admit. Instagram wants an image-anchored caption, LinkedIn wants a readable professional post, and X threads reward a tighter sequential structure. The wrong prompt usually creates a post that technically works but feels native nowhere.",
    keyTradeoffs: "Instagram Caption Writer is strongest when the visual leads and the text supports it. LinkedIn Post Writer is better when the idea needs a clear professional angle and scan-friendly structure. X Thread Writer is best when the topic needs a sequence, but overkill for ideas that should stay short.",
    realWorldScenarios: "Use Instagram Caption Writer for photo, reel, and lifestyle or brand posts. Use LinkedIn Post Writer for work lessons, launches, and professional reflections. Use X Thread Writer for frameworks, breakdowns, and multi-part ideas that need progression.",
    successMetrics: "The right prompt should make the post feel native to the platform and reduce how much rewriting you do after the first draft.",
    contenders: [
      { kind: "prompt", id: "p65" },
      { kind: "prompt", id: "p66" },
      { kind: "prompt", id: "p67" },
    ...
    criteria: [
      { name: "Platform fit", notes: "How well the prompt matches the native style of the platform." },
      { name: "Structure", notes: "Whether the format helps a single insight, a post, or a sequence land better." },
      { name: "Audience tone", notes: "How well it matches casual, professional, or idea-led audiences." },
      { name: "Repurposing value", notes: "How easily the output can be adapted into other formats." },
    ],
    verdict:
      "Use Instagram Caption Writer when the visual is doing most of the work, LinkedIn Post Writer when the post needs a clean professional angle, and X Thread Writer when the idea really needs a sequence to breathe.",
    tags: ["social-media", "creator", "comparison", "prompts"],
    updatedAtISO: "2026-04-20",
  },
  {
    id: "cmp26",
    slug: "reel-hook-generator-vs-carousel-post-outline-vs-social-content-repurposer",
    title: "Reel Hook Generator vs Carousel Post Outline vs Social Content Repurposer",
    description: "Three creator prompts for three different parts of the social workflow: opening faster, structuring a swipe post, or turning one asset into many.",
    whenToUse: "Use this when you are creating social content and want to choose the right prompt for the bottleneck you actually have. These prompts all help publishing, but they solve very different workflow problems.",
    decisionContext: "A weak content workflow can fail at different points. Sometimes the problem is the opening hook, sometimes it is slide structure, and sometimes the real need is turning one finished asset into several smaller platform-ready pieces.",
    keyTradeoffs: "Reel Hook Generator is best for the first seconds of short-form video but not for full post structure. Carousel Post Outline is strongest when the idea needs a visual sequence and a swipe logic. Social Content Repurposer is best when you already have source material and need multiple outputs, but weaker if the underlying idea is not solid yet.",
    realWorldScenarios: "Use Reel Hook Generator for talking-head videos and short educational clips. Use Carousel Post Outline for visual breakdowns, mini case studies, and swipe posts. Use Social Content Repurposer when adapting a blog, podcast, webinar, or long post into multiple platform formats.",
    successMetrics: "The strongest prompt is the one that removes the current bottleneck fastest and leaves you with something you can actually post.",
    contenders: [
      { kind: "prompt", id: "p68" },
      { kind: "prompt", id: "p69" },
      { kind: "prompt", id: "p72" },
    ...
    criteria: [
      { name: "Workflow stage", notes: "Whether the prompt best serves ideation, structuring, or repurposing." },
      { name: "Speed to output", notes: "How quickly it gets you from stuck to publishable material." },
      { name: "Content depth", notes: "How much substance the format can carry without falling apart." },
      { name: "Reuse value", notes: "Whether the output can feed more than one platform or format." },
    ],
    verdict:
      "Use Reel Hook Generator when the opening is the problem, Carousel Post Outline when the idea needs a visual sequence, and Social Content Repurposer when you already have a strong source asset and want more mileage from it.",
    tags: ["social-media", "creator", "comparison", "workflow"],
    updatedAtISO: "2026-04-20",
  },
];
