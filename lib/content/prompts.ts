...
},
{
  ...
  technicalRequirability: "Compatible with all major models. Claude provides thorough risk identification. GPT creates clear priority matrices. Gemini sometimes identifies non-obvious risks. Works for any domain or project type.",
