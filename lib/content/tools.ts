...
export const tools: Tool[] = [
...

  {
    ...
    description:
      "PlayHT is a TTS platform offering a range of voices and integrations for voiceovers and product use cases.",
    useCases: ["Voiceovers", "Narration", "App TTS", "Content dubbing"],
    pros: ["Good voice variety", "Useful APIs", "Creator workflows"],
    cons: ["Quality varies by voice", "Costs scale with usage"],
    pricing: { tier: "paid", note: "Plans vary by usage" },
    alternatives: [{ name: "ElevenLabs", slug: "elevenlabs" }, { name: "Azure TTS", slug: "azure-tts" }],
    tags: ["audio", "voice"],
    rating: 4.2,
    users: "Popular",
    updatedAtISO: "2026-01-24",
...

  {
    ...
    description:
      "Azure TTS is Microsoft’s speech synthesis offering. It’s a safe pick for enterprise stacks and teams already using Azure services.",
    useCases: ["Product TTS", "Enterprise apps", "Call center tooling", "Accessibility"],
    pros: ["Enterprise integration", "Predictable ops", "Good documentation"],
    cons: ["Less creator-friendly UX", "Can feel heavy for small projects"],
    pricing: { tier: "paid", note: "Usage-based (cloud billing)" },
    alternatives: [{ name: "ElevenLabs", slug: "elevenlabs" }, { name: "PlayHT", slug: "playht" }],
    tags: ["audio", "voice", "dev"],
    rating: 4.1,
    users: "Enterprise",
    updatedAtISO: "2026-01-24",
  },
